...
<div class="div h-screen w-24 bg-gray-800 shadow-lg z-40" id="bar">
	...
	<Boton nombre="Capas" seccion={2}
		><svg class="w-8 h-8  fill-gray-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"
			><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path
	...
	<Boton nombre="Normativas" seccion={3}
		><svg class="w-8 h-8  fill-gray-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"
			><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path
